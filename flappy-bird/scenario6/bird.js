...
function drawBird() {
	...
	if (!collided /*This means if collided === false*/) {
		if (bird.jump) {
...
export { bird, jump }; //We now going to export the function "jump" for it's use in the control.js file. You can have both an "export default" and multiple/one export. But there can only be one "export default".
